Shader "Custom/Water"
{
    Properties
    {
		...
		_NoiseFrequency("Wave Frequency", Range(0,4)) = 0.5
		_NoiseOffset("Wave Offset", Vector) = (0,0,0,0)
		_Refract("Refraction Amount", Range(0, 0.2)) = 0.1
    }
    SubShader
    {
		...
		void vert(inout appdata v, out Input o)
		{
			...
			o.refract = float4(v.normal,0) * _Refract;
		}
		...
		half4 LightingSimpleSpecular(SurfaceOutput s, half3 lightDir, half3 viewDir, half atten) {
			...
			half4 c;
			c.rgb = (s.Albedo * _LightColor0.rgb + _LightColor0.rgb * spec);
			c.a = s.Alpha;
			return c;
		}
        ...
        {
            fixed4 c = tex2Dproj(_GrabPassTex, UNITY_PROJ_COORD(IN.grabUV + IN.refract)) * _Color;
			o.Albedo = c.rgb;
        }
        ENDCG
    }
